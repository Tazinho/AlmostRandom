...
The context includes how the data was obtained. The measurements come from a live-animal competition, and the [collection notes](https://github.com/hadley/frog-jumping/blob/main/data-collection.md) describe [how participants prompt the frogs to jump](https://journals.biologists.com/jeb/article/216/21/3947/11669/Chasing-maximal-performance-a-cautionary-tale-from). For me, that raises animal-welfare concerns alongside the curiosity of the example. That is part of the provenance too, and worth keeping visible rather than treating the event as just a quirky backdrop.
